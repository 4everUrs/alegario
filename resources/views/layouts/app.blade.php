...
<head>
    ...
    <title>Alegario Cure Dashboard</title>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{route('dashboard')}}" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Alegario Cure</span>
            </a>
    ...
    <footer id="footer" class="footer fixed mt-4">
        ...
        <div class="credits">
            ...
            Disclaimer: This is for educational purposes only. <a href="https://bcp.edu.ph">Bestlink College of the
                Philippines</a>
        </div>
    </footer><!-- End Footer -->
